...
class Snippet(models.Model):
    ...
    id = models.AutoField(verbose_name='日報ID',primary_key=True,editable=False,blank=False, null=False)
    ...
    end_mileage = models.IntegerField(verbose_name='到着時メーター',blank=False, null=False)
    start_time = models.TimeField(verbose_name='始業時間',blank=False, null=False,max_length=10)
    end_time = models.TimeField(verbose_name='終業時間',blank=False, null=False,max_length=10)
    start_point = models.CharField(verbose_name='出発地点',blank=False, null=False,max_length=10)
    end_point = models.CharField(verbose_name='最終到着地点',blank=False, null=False,max_length=10)
    break_spot = models.CharField(verbose_name='休憩地点',blank=False, null=False,max_length=10)
    weather = models.CharField(verbose_name='天気', max_length=5, blank=False, null=False)
    gasoline_amount = models.FloatField(verbose_name='給油',max_length=4,blank=True, null=True)
    oil = models.FloatField(verbose_name='オイル',max_length=4,blank=True, null=True)
    is_trouble_situation = models.BooleanField(verbose_name='事故/遅延等異常_状況',default=False,blank=True, null=False)
    is_trouble_cause = models.BooleanField(verbose_name='事故/遅延等異常_原因',default=False,blank=True, null=False)
    is_trouble_support = models.BooleanField(verbose_name='事故/遅延等異常_処置',default=False,blank=True, null=False)
    create_at = models.DateTimeField(verbose_name="作成日時",auto_now_add=True)
    update_at = models.DateTimeField(verbose_name="更新日時",auto_now=True)
    def __str__(self):
