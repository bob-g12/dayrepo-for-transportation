...
class Snippet(models.Model):
    ...
    start_time = models.TimeField(verbose_name='始業時間',blank=True, null=True,max_length=10)
    end_time = models.TimeField(verbose_name='終業時間',blank=True, null=True,max_length=10)
    ...
    weather = models.CharField(verbose_name='天気', max_length=5, blank=True, null=True)
