    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_id', models.ForeignKey(default=False, on_delete=django.db.models.deletion.DO_NOTHING, to='snippets.car', verbose_name='車両id')),
                ('dutiestrouble_id', models.ForeignKey(default=False, on_delete=django.db.models.deletion.DO_NOTHING, to='snippets.dutiestrouble')),
            ],
            options={
                'verbose_name': '日報',
                'db_table': 'snippets',
