# Generated by Django 4.2.2 on 2024-02-20 16:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Snippet',
            fields=[
                ('id', models.AutoField(default=False, editable=False, primary_key=True, serialize=False, verbose_name='日報ID')),
                ('start_mileage', models.IntegerField(default=False, verbose_name='出発時メーター')),
                ('end_mileage', models.IntegerField(default=False, verbose_name='到着時メーター')),
                ('start_time', models.TimeField(default=False, max_length=10, verbose_name='始業時間')),
                ('end_time', models.TimeField(default=False, max_length=10, verbose_name='終業時間')),
                ('start_point', models.CharField(max_length=10, verbose_name='出発地点')),
                ('end_point', models.CharField(max_length=10, verbose_name='最終到着地点')),
                ('break_spot', models.CharField(max_length=10, verbose_name='休憩地点')),
                ('weather', models.CharField(default=False, max_length=5, verbose_name='天気')),
