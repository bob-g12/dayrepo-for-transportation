...
=======
# Generated by Django 4.2.2 on 2024-02-22 17:15
...
=======
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_at', models.DateTimeField(auto_now=True, verbose_name='更新日時')),
                ('account_id', models.ForeignKey(default=False, on_delete=django.db.models.deletion.DO_NOTHING, to='snippets.account', verbose_name='アカウントid')),
                ('duties_id', models.ForeignKey(default=False, on_delete=django.db.models.deletion.DO_NOTHING, to='snippets.dutiestrouble')),
            ],
            options={
                'verbose_name': '日報',
                'db_table': 'snippets',
