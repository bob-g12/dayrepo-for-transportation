...
class Car(models.Model):
    ...
    id = models.AutoField(verbose_name='車両ID',primary_key=True,editable=False,max_length=6,blank=False, null=False)
    vehicle_number = models.CharField(verbose_name='車両番号',max_length=15,blank=False, null=False)
    now_mileage = models.IntegerField(verbose_name='走行距離',max_length=25,blank=False, null=False)
    def __str__(self):
